...
describe('QuarterlyNoteManager', () => {
    ...
    let settingsRepository: jest.Mocked<SettingsRepository<QuarterlyNotesPeriodicNoteSettings>>;
    ...
    beforeEach(() => {
        ...
        } as jest.Mocked<SettingsRepository<QuarterlyNotesPeriodicNoteSettings>>;
        fileNameBuilder = {
    ...
    it('should open a note based on the month and settings', async () => {
        ...
        const settings: QuarterlyNotesPeriodicNoteSettings = {
