...
export class OpenYearlyNoteCommandHandler implements CommandHandler {
    constructor(
    ...
    public async execute(): Promise<void> {
        ...
        this.calendarViewModel.setSelectedPeriod(week.year);
        await this.viewModel.openNote(ModifierKey.None, week.year);
    }
}